...
values (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'customer1', 'address 1', '51110000',STRINGDECODE('customer1\n5111 0000\naddress 1'),'Facebook','BOC - Kiwi', null, 12, 118, '(Inventory1) 100 * 1 (Inventory2) 10 * 3 - 12 = 118', 'PREPARING', 'o1' );
INSERT INTO orders (create_time, update_time, customer, address, tel, content, source, payment_method, payment_date, discount, total_billing, calculator, status, id)
values (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'customer2', 'address 2', '32221111',STRINGDECODE('customer2\n32221111\naddress 2'), 'WhatsApp','Payme - Jessie',CURRENT_TIMESTAMP, null, null, null, 'PREPARING','o2' );
...
INSERT INTO orders (create_time, update_time, customer, address, tel, content, source, payment_method, payment_date, discount, total_billing, calculator, status, id)
values (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'customer1', 'address 1', '22220000',STRINGDECODE('customer1\n22220000\naddress 1'),'Facebook','BOC - Kiwi', CURRENT_TIMESTAMP, 12, 118, '(Inventory1) 100 * 1 (Inventory2) 10 * 3 - 12 = 118', 'PENDING_DELIVERY', 'o3' );
...
values (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'customer2', 'address 2', '10001000',STRINGDECODE('customer2\n10001000\naddress 2'), 'WhatsApp','Payme - Jessie',CURRENT_TIMESTAMP, 3, 297, STRINGDECODE('(Inventory1) $100 * 3\n = $300 - $3\n= $297'), 25, CURRENT_TIMESTAMP, 'Kiwi', '02321344222', 'COMPLETED','o4' );
